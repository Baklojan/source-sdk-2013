...
#else
			// Since we are using a shadow map depth texture with a resolution that is greater than the framebuffer size, we use RT_SIZE_NO_CHANGE instead of RT_SIZE_OFFSCREEN
